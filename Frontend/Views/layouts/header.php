    ...
    <nav class="navbar navbar-default" id="navbar">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/Frontend/Views/site/index.php">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-my-style">
                    <li>
                        <a href="../site/index.php" class="<?php echo $pageName == "index" || $pageName == "site" ? "active-link" : "nav-option-style" ?>"><span class="glyphicon glyphicon-home"></span> Página Principal</a>
                    </li>
