    ...
    <nav class="navbar navbar-default" id="navbar">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/Frontend/Views/site/indexEmpresa.php">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-my-style">
                    <li>
                        <a href="../site/indexEmpresa.php" class="<?php echo $pageName == "index" || $pageName == "site" ? "active-link" : "nav-option-style" ?>"><span class="glyphicon glyphicon-home"></span> Página Principal</a>
                    </li>
                    <li id="head-dropdown-menu" class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="propostasViewEmpresas.php" class="<?php echo $pageName == "discounts" ? "sub-nav-option-style-active" : "sub-nav-option-style" ?>">Propostas</a></li>
