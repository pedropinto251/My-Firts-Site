    ...
    <nav class="navbar navbar-default" id="navbar">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/Frontend/Views/site/indexDocente.php">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-my-style">
                    <li>
                        <a href="../site/indexDocente.php" class="<?php echo $pageName == "index" || $pageName == "site" ? "active-link" : "nav-option-style" ?>"><span class="glyphicon glyphicon-home"></span> Página Principal</a>
                    </li>
                    <li id="head-dropdown-menu" class="dropdown">
                        ...
                        <li><a href="propostas.php" class="<?php echo $pageName == "discounts" ? "sub-nav-option-style-active" : "sub-nav-option-style" ?>">Propostas</a></li>
                            ...
                            <li><a href="SelecionarEstagio.php" class="<?php echo $pageName == "" ? "sub-nav-option-style-active" : "sub-nav-option-style" ?>">Estagios a orientar</a></li>
                            <li><a href="SubmissaoProjetoDocentes.php" class="<?php echo $pageName == "" ? "sub-nav-option-style-active" : "sub-nav-option-style" ?>">Submissão de projetos para avaliação</a></li>
