...
<head>
    ...
    <?php include_once $_SERVER["DOCUMENT_ROOT"] . "/Backend/Actions/ActionSubmissaoProjeto.php"; ?>
</head>
<body>
<header>
...
<div class="main-content">
    <h2>Submissão de Projetos para avaliação</h2>
    <?php echo $mensagem; ?>
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
        
        <label for="Responsavel_ID">Responsavel ID:</label>
        <input type="text" name="Responsavel_ID" value="<?php echo $Responsavel_ID; ?>" required>
